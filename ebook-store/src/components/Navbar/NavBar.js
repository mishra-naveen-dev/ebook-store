          ...
          {isMobile ? (
            <>
              ...
              <MobileMenu open={openMenu}>
                ...
                <StyledButton color="inherit" component={Link} to="/cartpage" startIcon={<StoreIcon sx={{ fontSize: '1.5rem' }} />} fullWidth>
                  Shop
                </StyledButton>
            ...
            <MenuContainer>
              ...
              <StyledButton color="inherit" component={Link} to="/cartpage" startIcon={<StoreIcon sx={{ fontSize: '1.5rem' }} />}>
                Shop
              </StyledButton>
